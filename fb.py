...
def show_program():
 ...
 ------------------------------------------------------
    ...
    Date       05/09/2019 
    Jabber     aymankhalfatni18@gmail.com
...
def info_ga():
  ...
  -------------       -------------------------------------
   ...
   get_data           get access token facebook
   get_info           show information about your friend

   dump_id            show number phone your friend
   dump_phone         show email adress
...
def menu_bot():
 ...
 ---------   ------------------------------------
   ...
   [ 02 ]      auto chacker
   [ 03 ]      auto hacking
   [ 04 ]      test access token
   [ 05 ]      removed profil facebook victime
